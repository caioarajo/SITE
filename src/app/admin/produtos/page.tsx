...
function ProdutosPageContent() {
  ...
  const [form, setForm] = useState<Partial<ProductRow> | null>(null);
  ...
  async function save(e: FormEvent) {
    ...
    const { error } = id
      ...
      : await supabase.from("products").insert({ ...rest, name: rest.name! });
  ...
  return (
    <>
      <div className="admin-topbar">
        <div>
          <h1>Produtos</h1>
          <p>Catálogo de produtos e serviços usados nos orçamentos</p>
        </div>
      ...
      <div className="admin-card">
        <div className="admin-table-wrap">
          ...
          {!loading && items.length === 0 && <div className="empty-state">Nenhum produto cadastrado.</div>}
        </div>
      </div>
            ...
            <div className="field-row">
              ...
              <div className="field-group">
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, cost_price: e.target.value ? Number(e.target.value) : null })}
                />
              </div>
            </div>
